---
name: build
description: Drive any code change in deenv end-to-end — isolated worktree off LOCAL main, brief a background agent, verify, review, commit, FF-merge. Use PROACTIVELY whenever a concrete change is ready to build and other Claude sessions may share the tree. Args (optional): "slice" (default — Gherkin-first, slice-builder agent), "feature" (feature-builder agent, no Gherkin gate), "ui" (feature-builder agent + ui+ux reviewers).
---
