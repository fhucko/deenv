...
public sealed class AccessFloor
{
    ...
    private static bool ReferencesCurrentUser(ICodeValue value) => value switch
    {
        ...
        CodeTernary t => ReferencesCurrentUser(t.Condition) || ReferencesCurrentUser(t.Then) || ReferencesCurrentUser(t.Else),
    ...
    private static bool ReferencesObject(ICodeValue value) => value switch
    {
        ...
        CodeTernary t => ReferencesObject(t.Condition) || ReferencesObject(t.Then) || ReferencesObject(t.Else),
